...
// console.log(show)
  ...
  <Button variant="contained" type="button" class="close" data-dismiss="alert">&times;</Button>
  ...
  <h2 >Login</h2>
    ...
    <TextField id="outlined-basic" label="Email" variant="outlined" type="email" className="form-control" placeholder="Enter email" name="email" value={user.email} onChange={userInput} required />
  </div>
  <div className="form-group">
